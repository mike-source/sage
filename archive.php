      ...
      <div <?php if(get_sub_field('element_id')): ?>id="<?php echo str_replace(' ', '-', strtolower(get_sub_field('element_id'))); ?>" <?php endif;?>class="wrapper wrapper--normal col-1-1-1 archive">
...
<?php $i = 1; while(have_posts()): the_post(); ?>
          <div class="block col-1-1-1__block-1 block--<?php echo $i; ?> post">
            <div class="inner">
