      ...
      <div <?php get_template_part('templates/components/wrapper-id'); ?>class="wrapper wrapper--<?php the_sub_field('width'); ?> col-1-1"<?php get_template_part('templates/components/wrapper-inline-styles'); ?>>
